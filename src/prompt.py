...
→ If user responds with NO:
  SPEAK (Hindi): "No problem. I'll call you back later. What's the best time for you — morning or evening?" 
...
Unmistakably pause after each course name and before the next course name.
...
SPEAK: आप भी चाहें तो अपना सफर आज से start कर सकती हैं।
...
SPEAK (Hindi): तो बताइए — आप full payment prefer करेंगी या installments में pay करेंगी? 
